...
print('═══════════════════════════════════════════');
print('🌊 GROUNDWATER POTENTIAL MAPPING - UNA');
print('═══════════════════════════════════════════');
...
Export.image.toDrive({
  ...
  description: 'UNA_GW_Probability',
  folder: 'GEE_Exports',
  region: studyArea,
  scale: 30,
  maxPixels: 1e13
...
Export.table.toDrive({
  ...
  description: 'UNA_GW_Area_Statistics',
  folder: 'GEE_Exports',
  fileFormat: 'CSV',
...
Export.table.toDrive({
  ...
  description: 'UNA_GW_Training_Points',
  folder: 'GEE_Exports',
  fileFormat: 'CSV'
});
...
Export.table.toDrive({
  ...
  description: 'UNA_GW_Variable_Importance',
  folder: 'GEE_Exports',
  fileFormat: 'CSV',
